				...
				<table class="calendar">
					...
					<tr>
						...
						<td class = "calend_td">
						     ...
						     <div class="calend_fg"><a href="pancakes.php"> <img class = img2 src="resources/images/pk.jpg" alt = "Image of Pancakes"></a></div>
						     <div style="clear: left"></div>
						</td>
						<td class = "calend_td">
					...
					<tr>
						...
						<td class = "calend_td">
							...
							<div class="calend_fg"><a href="meatballs.php"> <img class = img2 src="resources/images/mb.jpg" alt = "Image of Meatballs"></a></div>
							<div style="clear: left"></div>
						</td>
						<td class = "calend_td">
